...
export default function RegisterModal() {
    ...
    const handleFinalRegister = async (e: React.FormEvent) => {
        ...
        try {
            ...
            closeModals(); // Cerramos el modal antes de redirigir para evitar parpadeos
          ...
          <div className="relative w-full max-w-lg bg-white rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh] overflow-y-auto ring-1 ring-gray-200">
            ...
            <div className="bg-gradient-to-br from-indigo-600 to-purple-700 p-8 text-center sticky top-0 z-10">
                ...
                <p className="text-indigo-100 text-sm mt-2 font-medium">
                    {step === 1 ? "Empieza a ganar dinero montando muebles hoy mismo" : `Hemos enviado un código a ${email}`}
                </p>
            ...
            <div className="p-8 pt-6">
                ...
                <div className="mt-8 text-center border-t border-gray-100 pt-6">
                    <p className="text-sm text-gray-500">
                        ¿Ya tienes cuenta?{' '}
                        <button onClick={switchToLogin} className="font-bold text-purple-600 hover:text-purple-800 hover:underline transition-colors focus:outline-none focus:ring-2 focus:ring-purple-500 rounded px-1">
                        Inicia sesión
                        </button>
                    </p>
                </div>
